...
<head>
  ...
  <title>Museum Bekasi - Member Login</title>
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="login-form">
                  ...
                  <form class="user" action="login_member_process.php" method="POST">
                  ...
                  <hr>
                  <div class="text-center">
                    <a class="font-weight-bold small" href="register_member.php">Don't have an account? Sign Up!</a>
                  </div>
                  <hr>
                  <?php
